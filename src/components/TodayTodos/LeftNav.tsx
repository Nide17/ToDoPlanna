...
const LeftNav = () => {
    return (
        <div className="flex h-screen overflow-hidden bg-white dark:bg-gray-900">
            ...
            {/* <!-- Desktop navigation --> */}
            <aside id="default-sidebar" className="fixed top-0 sm:absolute left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
